...
// export const swapFromETH = async (amountIn, fromToken, toToken, toAddress, uniswapRouter) => {
//     let ABI = ["function swapExactETHForTokens(uint256 amountOutMin, address[] calldata path, address to, uint256 deadline)"];
//     let iface = new ethers.utils.Interface(ABI);
//     let incData = iface.encodeFunctionData("swapExactETHForTokens", [0, [fromToken, toToken], toAddress, "1985853996"]);
//     let opData = abi.encode(["address", "uint256", "bytes"], [uniswapRouter, amount, incData]);
//     return opData
// }
